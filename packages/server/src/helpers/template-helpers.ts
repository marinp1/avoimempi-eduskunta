...
export { partyColor, partyShortName, resolveParty } from "#server/domain";
...
export type {
  BlocBar,
  BlocSegment,
} from "#server/features/person/pages/roster-shared.view-model";
...
export type {
  ...
  SpeakerActivity,
  HomeData,
} from "../features/home/pages/home.view-model";
