...
function makeAloiteRow(
  ...
  return {
    ...
    _source: {
      ...
      vaskiPath: "vaski-data/keskustelualoite/page_1.json",
    },
    contents: {
      Siirto: {
        SiirtoMetatieto: {
        ...
        SiirtoAsiakirja: {
          RakenneAsiakirja: {
            EduskuntaAloite: {
              IdentifiointiOsa: {
                Nimeke: { NimekeTeksti: "Keskustelualoite kokonaisturvallisuudesta" },
                Toimija: {
                  Henkilo: {
                    "@_muuTunnus": "1001",
                    EtuNimi: "Aino",
...
function makeKasittelyRow(
  ...
  return {
    ...
    _source: {
      ...
      vaskiPath: "vaski-data/keskustelualoite/page_2.json",
    },
    contents: {
      Siirto: {
        SiirtoAsiakirja: {
