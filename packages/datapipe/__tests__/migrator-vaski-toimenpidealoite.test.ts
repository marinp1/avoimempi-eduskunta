...
import createSubMigrator from "../migrator/fn/VaskiData/submigrators/toimenpidealoite";
...
function makeAloiteRow(overrides: Partial<VaskiEntry> = {}): VaskiEntry {
  return {
    ...
    _source: {
      ...
      vaskiPath:
        "vaski-data/toimenpidealoite/page_000000000001+000000000100.json",
    },
    contents: {
      Siirto: {
        SiirtoMetatieto: {
...
function makeKasittelyRow(overrides: Partial<VaskiEntry> = {}): VaskiEntry {
  return {
    ...
    _source: {
      ...
      vaskiPath:
        "vaski-data/toimenpidealoite/page_000000000002+000000000101.json",
    },
    contents: {
      Siirto: {
        SiirtoAsiakirja: {
