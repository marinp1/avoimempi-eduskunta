...
## 1. Composition -> Representative -> Speeches

Does not open propely, Bun erros in logs.

## 2. Votings -> Related votings

Unrelated votings are grouped.

## 3. Analytics -> Attendance

The UI is not mobile friendly (grid visualisation).

## 4. Migration history

The UI shows only one migration date, disallowing to see details of previous changes.

# Features to implement

## 1. Possible to remove the "analytics" algother?
